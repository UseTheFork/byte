...
if TYPE_CHECKING:
    ...
    from byte.workflow.workflows.constitution_workflow import ConstitutionWorkflow
    from byte.workflow.workflows.create_skill_workflow import CreateSkillWorkflow
