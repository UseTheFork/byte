...
from byte.specs import CreateQuickSpecWorkflow
from byte.tui import Messages


class QuickSpecCommand(Command):
    """ """
    ...
    async def execute(self, args: Namespace, raw_args: str) -> None:
        ...
        create_quick_spec_workflow = self.app.make(CreateQuickSpecWorkflow)
        ...
        workflow_phases = PhaseUtils.to_phase_dict(create_quick_spec_workflow.get_phases())
        await workflow_service.execute(
            create_quick_spec_workflow, {"user_request": raw_args, "workflow_phases": workflow_phases}
        )
