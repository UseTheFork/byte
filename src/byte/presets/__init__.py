...
if TYPE_CHECKING:
    from byte.presets.command.load_preset_command import LoadPresetCommand
    from byte.presets.command.save_preset_command import SavePresetCommand
    from byte.presets.config import PresetsConfig
    from byte.presets.service_provider import PresetsProvider
