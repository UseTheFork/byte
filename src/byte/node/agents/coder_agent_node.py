...
coder_user_template = [
    ...
    "- Briefly acknowledge the task, then immediately begin using tools to implement changes",
    "- Do NOT provide lengthy explanations or full code blocks in messages — use tools instead",
    "- After completing all changes, provide a SHORT, CONCISE summary as a bulleted list of what was changed",
    Boundary.close(BoundaryType.RESPONSE_FORMAT),
    Boundary.open(BoundaryType.EXAMPLE),
    "Example 1 - Single file edit:",
    "```",
    "Implementing the requested changes to `app.py`.",
    "",
    "[uses edit_file tool]",
    "",
    "Changes completed:",
    ...
    "",
    "[uses write_file tool for hello.py]",
    "[uses edit_file tool for main.py]",
    "",
    "Changes completed:",
    ...
    "```",
    "Implementing the requested changes to the User model and authentication.",
    "",
    "[uses edit_file tool for models/user.py]",
    "[uses edit_file tool for services/auth.py]",
    "",
    "Changes completed:",
