...
coder_user_template = [
    ...
    # "For every task, follow this sequence internally (don't narrate it):",
    # "",
    # "1. Read the AI: / AI! comments in the provided files to understand what changes are needed.",
    # "2. Plan the changes required.",
    # "3. Implement the changes using the available tools.",
    # "4. Remove the AI: / AI! comment markers from the code.",
