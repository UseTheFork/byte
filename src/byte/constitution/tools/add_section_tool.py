...
class AddSectionTool(BaseTool):
    ...
    input_schema = {
        ...
        "properties": {
            ...
            "order": {
                "type": "integer",
                "description": "Display order of the section (e.g. 1, 2, 3). Defaults to 1.",
            },
        },
        "required": ["name"],
    }
    ...
    @override
    async def run(self, name: str, applies_to: list[str] | None = None, order: int = 1, **kwargs) -> ToolResult:
