...
class Preamble(Leaf):
    ...
    async def assemble(self, prompt_assembler: PromptAssembler) -> str:
        lines = [
            ...
            f"- **User Message ({SectionType.PROJECT_FILES})** — An automatically generated message containing the most up-to-date state of all relevant files and system context. This message is regenerated after **every** tool call to reflect the latest changes.",
            "",
