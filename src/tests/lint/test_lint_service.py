...
class TestLintService(BaseTest):
    ...
    @pytest.mark.asyncio
    async def test_validate_raises_when_linting_disabled(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_validate_raises_when_no_commands_configured(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_validate_returns_true_when_configured(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_handle_calls_lint_changed_files(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_changed_files_filters_removed_files(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_creates_lint_file_for_each_command(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_filters_by_language(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_processes_all_files_when_no_languages(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_processes_all_files_with_wildcard(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_executes_commands(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_captures_stdout(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_captures_stderr(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_lint_files_records_exit_code(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_display_results_summary_returns_false_when_no_issues(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_format_lint_errors_wraps_errors_in_boundaries(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_format_lint_errors_includes_file_source(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_format_lint_errors_uses_stdout_when_no_stderr(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_format_lint_errors_includes_header(self, application: Application):
