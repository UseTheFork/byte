...
class TestLSPService(BaseTest):
    ...
    @pytest.mark.asyncio
    async def test_service_boots_without_errors(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_language_map_empty_when_no_servers_configured(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_get_client_for_file_returns_none_when_lsp_disabled(self, application: Application):
