...
@pytest.mark.asyncio
async def test_add_context_adds_model_to_store(application: Application):
...
@pytest.mark.asyncio
async def test_remove_context_removes_model_from_store(application: Application):
...
@pytest.mark.asyncio
async def test_remove_context_deletes_file(application: Application):
...
@pytest.mark.asyncio
async def test_get_context_returns_model(application: Application):
...
@pytest.mark.asyncio
async def test_get_context_returns_none_for_missing_key(application: Application):
...
@pytest.mark.asyncio
async def test_clear_context_removes_all_models(application: Application):
...
@pytest.mark.asyncio
async def test_clear_context_deletes_all_files(application: Application):
...
@pytest.mark.asyncio
async def test_get_all_context_returns_all_models(application: Application):
...
@pytest.mark.asyncio
async def test_add_session_context_hook_adds_contexts_to_payload(application: Application):
...
@pytest.mark.asyncio
async def test_add_session_context_hook_handles_empty_context(application: Application):
...
@pytest.mark.asyncio
async def test_session_context_includes_boundary_tags(application: Application):
...
@pytest.mark.asyncio
async def test_session_context_includes_metadata(application: Application):
...
@pytest.mark.asyncio
async def test_add_context_with_file_type(application: Application):
...
@pytest.mark.asyncio
async def test_add_context_with_web_type(application: Application):
...
@pytest.mark.asyncio
async def test_add_context_with_agent_type(application: Application):
...
@pytest.mark.asyncio
async def test_multiple_contexts_in_hook_payload(application: Application):
...
@pytest.mark.asyncio
async def test_add_context_returns_self_for_chaining(application: Application):
...
@pytest.mark.asyncio
async def test_remove_context_returns_self_for_chaining(application: Application):
...
@pytest.mark.asyncio
async def test_clear_context_returns_self_for_chaining(application: Application):
