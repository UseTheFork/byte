...
@pytest.mark.asyncio
async def test_loads_conventions_from_directory_on_boot(application: Application):
...
@pytest.mark.asyncio
async def test_handles_missing_conventions_directory(application: Application):
...
@pytest.mark.asyncio
async def test_add_convention_loads_file(application: Application):
...
@pytest.mark.asyncio
async def test_add_convention_handles_nonexistent_file(application: Application):
...
@pytest.mark.asyncio
async def test_drop_convention_removes_from_store(application: Application):
...
@pytest.mark.asyncio
async def test_clear_conventions_removes_all(application: Application):
...
@pytest.mark.asyncio
async def test_get_conventions_returns_all_conventions(application: Application):
...
@pytest.mark.asyncio
async def test_convention_content_includes_boundary_tags(application: Application):
...
@pytest.mark.asyncio
async def test_convention_content_includes_metadata(application: Application):
...
@pytest.mark.asyncio
async def test_add_project_context_hook_adds_conventions_to_payload(application: Application):
...
@pytest.mark.asyncio
async def test_add_project_context_hook_handles_empty_conventions(application: Application):
...
@pytest.mark.asyncio
async def test_conventions_sorted_alphabetically(application: Application):
...
@pytest.mark.asyncio
async def test_handles_convention_files_with_read_errors(application: Application):
...
@pytest.mark.asyncio
async def test_only_loads_markdown_files(application: Application):
...
@pytest.mark.asyncio
async def test_add_convention_returns_self_for_chaining(application: Application):
...
@pytest.mark.asyncio
async def test_drop_convention_returns_self_for_chaining(application: Application):
...
@pytest.mark.asyncio
async def test_clear_conventions_returns_self_for_chaining(application: Application):
