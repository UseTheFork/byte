...
class TestWatcherService(BaseTest):
    ...
    @pytest.mark.asyncio
    async def test_detects_file_deletion(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_ignores_files_matching_ignore_patterns(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_removes_file_from_context_when_deleted(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_ignores_directory_changes(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_ignores_files_in_ignored_directories(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_handles_rapid_file_changes(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_emits_file_changed_event(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_handles_file_modification(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_watcher_filter_uses_ignore_service(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_watcher_handles_custom_ignore_patterns(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_watcher_continues_after_error(self, application: Application):
