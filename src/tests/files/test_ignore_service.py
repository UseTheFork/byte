...
@pytest.mark.asyncio
async def test_loads_gitignore_patterns(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_pyc_files(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_pycache_directory(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_files_in_pycache_directory(application: Application):
...
@pytest.mark.asyncio
async def test_does_not_ignore_regular_python_files(application: Application):
...
@pytest.mark.asyncio
async def test_respects_custom_ignore_patterns_from_config(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_pytest_cache(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_nested_files_in_ignored_directory(application: Application):
...
@pytest.mark.asyncio
async def test_refresh_reloads_patterns(application: Application):
...
@pytest.mark.asyncio
async def test_handles_paths_outside_project_root(application: Application):
...
@pytest.mark.asyncio
async def test_get_pathspec_returns_compiled_spec(application: Application):
...
@pytest.mark.asyncio
async def test_handles_empty_gitignore(application: Application, tmp_path):
...
@pytest.mark.asyncio
async def test_handles_gitignore_with_comments(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_byte_cache_directory(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_node_modules(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_venv_directory(application: Application):
...
@pytest.mark.asyncio
async def test_ignores_git_directory(application: Application):
...
@pytest.mark.asyncio
async def test_handles_wildcard_patterns(application: Application):
...
@pytest.mark.asyncio
async def test_handles_directory_patterns_with_trailing_slash(application: Application):
...
@pytest.mark.asyncio
async def test_does_not_ignore_readme(application: Application):
...
@pytest.mark.asyncio
async def test_handles_multiple_ignore_sources(application: Application):
