...
@pytest.mark.asyncio
async def test_add_file_with_editable_mode(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_with_read_only_mode(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_returns_false_for_nonexistent_file(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_returns_false_for_already_added_file(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_with_wildcard_pattern(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_wildcard_returns_false_for_no_matches(application: Application):
...
@pytest.mark.asyncio
async def test_remove_file_from_context(application: Application):
...
@pytest.mark.asyncio
async def test_remove_file_returns_false_for_file_not_in_context(application: Application):
...
@pytest.mark.asyncio
async def test_remove_file_with_wildcard_pattern(application: Application):
...
@pytest.mark.asyncio
async def test_list_files_returns_all_files(application: Application):
...
@pytest.mark.asyncio
async def test_list_files_filtered_by_mode(application: Application):
...
@pytest.mark.asyncio
async def test_list_files_returns_sorted_by_relative_path(application: Application):
...
@pytest.mark.asyncio
async def test_set_file_mode_changes_mode(application: Application):
...
@pytest.mark.asyncio
async def test_set_file_mode_returns_false_for_file_not_in_context(application: Application):
...
@pytest.mark.asyncio
async def test_get_file_context_returns_context(application: Application):
...
@pytest.mark.asyncio
async def test_get_file_context_returns_none_for_file_not_in_context(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_with_read_only_files(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_with_editable_files(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_with_mixed_modes(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_returns_empty_for_no_files(application: Application):
...
@pytest.mark.asyncio
async def test_clear_context_removes_all_files(application: Application):
...
@pytest.mark.asyncio
async def test_get_project_files_returns_relative_paths(application: Application):
...
@pytest.mark.asyncio
async def test_get_project_files_filtered_by_extension(application: Application):
...
@pytest.mark.asyncio
async def test_find_project_files_with_pattern(application: Application):
...
@pytest.mark.asyncio
async def test_is_file_in_context_returns_true_for_added_file(application: Application):
...
@pytest.mark.asyncio
async def test_is_file_in_context_returns_false_for_file_not_added(application: Application):
...
@pytest.mark.asyncio
async def test_generate_project_hierarchy_returns_tree_structure(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_only_adds_discovered_files(application: Application):
...
@pytest.mark.asyncio
async def test_remove_file_wildcard_only_removes_discovered_files(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_includes_language_metadata(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_handles_unreadable_files(application: Application):
...
@pytest.mark.asyncio
async def test_add_file_with_relative_path(application: Application):
...
@pytest.mark.asyncio
async def test_remove_file_with_relative_path(application: Application):
...
@pytest.mark.asyncio
async def test_file_context_emits_file_added_event(application: Application):
...
@pytest.mark.asyncio
async def test_generate_context_prompt_with_line_numbers(application: Application):
