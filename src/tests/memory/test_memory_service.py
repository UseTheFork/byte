...
@pytest.mark.asyncio
async def test_get_checkpointer_returns_in_memory_saver(application: Application):
...
@pytest.mark.asyncio
async def test_get_checkpointer_returns_same_instance(application: Application):
...
@pytest.mark.asyncio
async def test_get_saver_returns_checkpointer(application: Application):
...
@pytest.mark.asyncio
async def test_create_thread_returns_unique_id(application: Application):
...
@pytest.mark.asyncio
async def test_create_thread_returns_different_ids(application: Application):
...
@pytest.mark.asyncio
async def test_set_current_thread_stores_thread_id(application: Application):
...
@pytest.mark.asyncio
async def test_get_current_thread_returns_none_initially(application: Application):
...
@pytest.mark.asyncio
async def test_get_current_thread_returns_set_thread(application: Application):
...
@pytest.mark.asyncio
async def test_get_or_create_thread_creates_thread_when_none_exists(application: Application):
...
@pytest.mark.asyncio
async def test_get_or_create_thread_returns_existing_thread(application: Application):
...
@pytest.mark.asyncio
async def test_get_or_create_thread_sets_current_thread(application: Application):
...
@pytest.mark.asyncio
async def test_new_thread_creates_and_sets_thread(application: Application):
...
@pytest.mark.asyncio
async def test_new_thread_replaces_existing_thread(application: Application):
...
@pytest.mark.asyncio
async def test_new_thread_returns_unique_ids(application: Application):
