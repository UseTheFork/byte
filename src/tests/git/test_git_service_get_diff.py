...
class TestGitServiceGetDiff(BaseTest):
    ...
    @pytest.mark.asyncio
    async def test_get_diff_new_file_added(self, application: Application):
        """Test get_diff detects newly added files."""
        from byte.git import GitService

        # Create and stage a new file
        test_file = await self.create_test_file(application, "new_file.txt", "new content")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_file_deleted(self, application: Application):
        """Test get_diff detects deleted files."""
        from byte.git import GitService

        # Create, commit, then delete a file
        test_file = await self.create_test_file(application, "to_delete.txt", "content to delete")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_file_modified(self, application: Application):
        """Test get_diff detects modified files with diff content."""
        from byte.git import GitService

        # Create, commit, then modify a file
        test_file = await self.create_test_file(application, "to_modify.txt", "original content\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_file_renamed(self, application: Application):
        """Test get_diff detects renamed files."""
        from byte.git import GitService

        # Create and commit a file
        test_file = await self.create_test_file(application, "old_name.txt", "content")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_multiple_files_mixed_changes(self, application: Application):
        """Test get_diff handles multiple files with different change types."""
        from byte.git import GitService

        # Create initial files and commit
        file1 = await self.create_test_file(application, "file1.txt", "content 1\n")
        file2 = await self.create_test_file(application, "file2.txt", "content 2\n")
        file3 = await self.create_test_file(application, "file3.txt", "content 3\n")
        ...
        # Add new file4
        file4 = await self.create_test_file(application, "file4.txt", "new content 4\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_with_previous_commits(self, application: Application):
        """Test get_diff only returns changes staged for next commit, not previous commits."""
        from byte.git import GitService

        # Create and commit file1
        file1 = await self.create_test_file(application, "committed1.txt", "committed content 1\n")
        ...
        file2 = await self.create_test_file(application, "committed2.txt", "committed content 2\n")
        repo.index.add([str(file2.relative_to(application.root_path()))])
        repo.index.commit("Second commit")

        # Now stage a new file
        file3 = await self.create_test_file(application, "staged.txt", "staged content\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_empty_when_nothing_staged(self, application: Application):
        """Test get_diff returns empty list when nothing is staged."""
        from byte.git import GitService

        # Create and commit a file
        file1 = await self.create_test_file(application, "committed.txt", "committed content\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_unstaged_changes(self, application: Application):
        """Test get_diff returns empty when changes are not staged."""
        from byte.git import GitService

        # Create, commit, then modify without staging
        test_file = await self.create_test_file(application, "unstaged.txt", "original\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_staged_vs_unstaged(self, application: Application):
        """Test get_diff only returns staged changes."""
        from byte.git import GitService

        # Create and commit two files
        file1 = await self.create_test_file(application, "staged_change.txt", "original 1\n")
        file2 = await self.create_test_file(application, "unstaged_change.txt", "original 2\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_binary_file(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_get_diff_large_file_modification(self, application: Application):
        """Test get_diff handles large file modifications."""
        from byte.git import GitService

        # Create a large file
        large_content = "line\n" * 1000
        test_file = await self.create_test_file(application, "large.txt", large_content)
    ...
    @pytest.mark.asyncio
    async def test_get_diff_file_with_special_characters(self, application: Application):
        """Test get_diff handles filenames with special characters."""
        from byte.git import GitService

        # Create file with special characters in name
        test_file = await self.create_test_file(application, "file-with_special.chars.txt", "content\n")
    ...
    @pytest.mark.asyncio
    async def test_get_diff_nested_directory_file(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_get_diff_whitespace_only_changes(self, application: Application):
        """Test get_diff detects whitespace-only changes."""
        from byte.git import GitService

        # Create and commit file
        test_file = await self.create_test_file(application, "whitespace.txt", "line1\nline2\n")
