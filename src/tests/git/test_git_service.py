...
@pytest.mark.asyncio
async def test_get_repo_returns_repository_instance(application: Application):
...
@pytest.mark.asyncio
async def test_get_changed_files_returns_modified_files(application: Application):
    """Test that get_changed_files returns list of modified files."""
    from byte.git import GitService

    # Create and modify a file
    test_file = await create_test_file(application, "test_modified.txt", "original content")
...
@pytest.mark.asyncio
async def test_get_changed_files_includes_untracked_by_default(application: Application):
    """Test that get_changed_files includes untracked files by default."""
    from byte.git import GitService

    # Create an untracked file
    await create_test_file(application, "untracked.txt", "untracked content")
...
@pytest.mark.asyncio
async def test_get_changed_files_excludes_untracked_when_disabled(application: Application):
    """Test that get_changed_files excludes untracked files when include_untracked=False."""
    from byte.git import GitService

    # Create an untracked file
    await create_test_file(application, "untracked2.txt", "untracked content")
...
@pytest.mark.asyncio
async def test_get_changed_files_includes_staged_files(application: Application):
    """Test that get_changed_files includes staged files."""
    from byte.git import GitService

    # Create and stage a file
    staged_file = await create_test_file(application, "staged.txt", "staged content")
...
@pytest.mark.asyncio
async def test_get_changed_files_removes_duplicates(application: Application):
    """Test that get_changed_files removes duplicate entries."""
    from byte.git import GitService

    # Create a file that's both modified and staged
    test_file = await create_test_file(application, "duplicate_test.txt", "original")
...
@pytest.mark.asyncio
async def test_commit_creates_commit_with_message(application: Application):
    """Test that commit creates a git commit with the provided message."""
    from byte.git import GitService

    # Create and stage a file
    test_file = await create_test_file(application, "commit_test.txt", "test content")
...
@pytest.mark.asyncio
async def test_stage_changes_adds_unstaged_files(application: Application, mocker):
    """Test that stage_changes adds unstaged files to the index."""

    from byte.git import GitService

    # Create a file and commit it
    test_file = await create_test_file(application, "stage_test.txt", "original")
...
@pytest.mark.asyncio
async def test_reset_unstages_specific_file(application: Application):
    """Test that reset unstages a specific file."""
    from byte.git import GitService

    # Create and stage a file
    test_file = await create_test_file(application, "reset_test.txt", "test content")
...
@pytest.mark.asyncio
async def test_reset_unstages_all_files_when_no_path(application: Application):
    """Test that reset without path unstages all files."""
    from byte.git import GitService

    # Create and stage multiple files
    file1 = await create_test_file(application, "reset_all_1.txt", "content 1")
    file2 = await create_test_file(application, "reset_all_2.txt", "content 2")

    service = application.make(GitService)
    repo = await service.get_repo()
    repo.index.add([str(file1.relative_to(application.root_path())), str(file2.relative_to(application.root_path()))])
...
@pytest.mark.asyncio
async def test_add_stages_specific_file(application: Application):
    """Test that add stages a specific file."""
    from byte.git import GitService

    # Create a file
    test_file = await create_test_file(application, "add_test.txt", "test content")
...
@pytest.mark.asyncio
async def test_remove_stages_file_deletion(application: Application):
    """Test that remove stages a file deletion."""
    from byte.git import GitService

    # Create, commit, then delete a file
    test_file = await create_test_file(application, "remove_test.txt", "test content")
...
@pytest.mark.asyncio
async def test_get_diff_returns_staged_changes(application: Application):
    """Test that get_diff with 'HEAD' returns staged changes."""
    from byte.git import GitService

    # Create and stage a file
    test_file = await create_test_file(application, "diff_test.txt", "test content")
...
@pytest.mark.asyncio
async def test_get_diff_doesnt_returns_unstaged_changes(application: Application):
    """Test that get_diff without argument returns unstaged changes."""
    from byte.git import GitService

    # Create, commit, then modify a file
    test_file = await create_test_file(application, "unstaged_diff.txt", "original")
...
@pytest.mark.asyncio
async def test_get_diff_includes_change_type(application: Application):
    """Test that get_diff includes change_type for each file."""
    from byte.git import GitService

    # Create and stage a new file
    test_file = await create_test_file(application, "change_type_test.txt", "new file")
...
@pytest.mark.asyncio
async def test_get_diff_includes_diff_content_for_modifications(application: Application):
    """Test that get_diff includes diff content for modified files."""
    from byte.git import GitService

    # Create, commit, then modify a file
    test_file = await create_test_file(application, "diff_content_test.txt", "original content")
...
@pytest.mark.asyncio
async def test_get_diff_clears_content_for_deletions(application: Application):
    """Test that get_diff clears diff content for deleted files."""
    from byte.git import GitService

    # Create, commit, then delete a file
    test_file = await create_test_file(application, "deletion_test.txt", "content to delete")
...
@pytest.mark.asyncio
async def test_get_diff_includes_status_flags(application: Application):
    """Test that get_diff includes is_renamed, is_modified, is_new, is_deleted flags."""
    from byte.git import GitService

    # Create and stage a new file
    test_file = await create_test_file(application, "flags_test.txt", "new file")
...
@pytest.mark.asyncio
async def test_get_diff_includes_message(application: Application):
    """Test that get_diff includes a descriptive message for each change."""
    from byte.git import GitService

    # Create and stage a new file
    test_file = await create_test_file(application, "message_test.txt", "new file")
