...
class TestCommitService(BaseTest):
    ...
    @pytest.mark.asyncio
    async def test_build_commit_prompt_returns_formatted_prompt(self, application: Application):
        """Test that build_commit_prompt returns a formatted prompt string."""
        from byte.git import CommitService, GitService

        # Create and stage a file
        test_file = await self.create_test_file(application, "prompt_test.txt", "test content")
    ...
    @pytest.mark.asyncio
    async def test_build_commit_prompt_includes_diff_content(self, application: Application):
        """Test that build_commit_prompt includes diff content for modified files."""
        from byte.git import CommitService, GitService

        # Create, commit, then modify a file
        test_file = await self.create_test_file(application, "diff_prompt_test.txt", "original content")
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_basic_message(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_with_scope(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_without_scope_when_disabled(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_with_body(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_without_body_when_disabled(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_normalizes_description(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_breaking_change_confirmed(self, application: Application, config, mocker):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_breaking_change_declined(self, application: Application, config, mocker):
    ...
    @pytest.mark.asyncio
    async def test_format_conventional_commit_breaking_change_disabled(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_process_commit_plan_creates_multiple_commits(self, application: Application):
        """Test that process_commit_plan creates separate commits for each group."""
        from byte.git import CommitService, GitService

        # Create multiple files
        file1 = await self.create_test_file(application, "plan_test1.txt", "content 1")
        file2 = await self.create_test_file(application, "plan_test2.txt", "content 2")
    ...
    @pytest.mark.asyncio
    async def test_process_commit_plan_handles_deleted_files(self, application: Application):
        """Test that process_commit_plan handles deleted files correctly."""
        from byte.git import CommitService, GitService

        # Create and commit a file
        test_file = await self.create_test_file(application, "delete_plan_test.txt", "content to delete")
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_includes_commit_types(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_includes_description_rules(self, application: Application):
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_includes_scopes_when_enabled(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_excludes_scope_when_disabled(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_excludes_body_when_disabled(self, application: Application, config):
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_excludes_breaking_changes_when_disabled(
    ...
    @pytest.mark.asyncio
    async def test_generate_commit_guidelines_includes_custom_description_guidelines(
        self, application: Application, config
    ):
