...
@pytest.mark.asyncio
async def test_boot_config_read_only_files(test_config: ByteConfg, create_test_file):
...
@pytest.mark.asyncio
async def test_boot_config_editable_files(test_config: ByteConfg, create_test_file):
...
@pytest.mark.asyncio
async def test_boot_config_mixed_files(test_config: ByteConfg, create_test_file):
