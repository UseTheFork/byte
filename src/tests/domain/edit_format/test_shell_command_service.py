...
from byte.domain.prompt_format.schemas import BlockStatus, ShellCommandBlock
...
class TestShellCommandServiceParsing:
    ...
    @pytest.mark.asyncio
    async def test_parse_single_sh_block(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_parse_single_bash_block(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_parse_multiple_commands_single_block(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_parse_multiple_blocks(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_parse_ignores_other_language_blocks(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_parse_strips_whitespace(self, shell_command_service: ShellCommandService):
...
class TestShellCommandServiceExecution:
    ...
    @pytest.mark.asyncio
    async def test_execute_successful_command(self, shell_command_service: ShellCommandService, monkeypatch):
        ...
        monkeypatch.setattr(shell_command_service, "prompt_for_confirmation", mock_confirm)
    ...
    @pytest.mark.asyncio
    async def test_execute_failed_command(self, shell_command_service: ShellCommandService, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_execute_user_cancels(self, shell_command_service: ShellCommandService, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_execute_timeout(self, shell_command_service: ShellCommandService, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_execute_subprocess_error(self, shell_command_service: ShellCommandService, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_execute_skips_invalid_blocks(self, shell_command_service: ShellCommandService, monkeypatch):
...
class TestShellCommandServiceUtilities:
    ...
    @pytest.mark.asyncio
    async def test_remove_blocks_from_content_single_command(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_remove_blocks_from_content_multiple_commands(self, shell_command_service: ShellCommandService):
    ...
    @pytest.mark.asyncio
    async def test_remove_blocks_preserves_non_shell_blocks(self, shell_command_service: ShellCommandService):
...
class TestShellCommandServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_handle_complete_workflow(self, shell_command_service: ShellCommandService, monkeypatch):
    ...
    @pytest.mark.asyncio
    async def test_handle_mixed_success_and_failure(self, shell_command_service: ShellCommandService, monkeypatch):
