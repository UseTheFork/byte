...
@pytest.mark.asyncio
async def test_boot_initializes_usage_analytics(application: Application):
...
@pytest.mark.asyncio
async def test_update_main_usage_updates_counters(application: Application):
...
@pytest.mark.asyncio
async def test_update_main_usage_accumulates_totals(application: Application):
...
@pytest.mark.asyncio
async def test_update_weak_usage_updates_counters(application: Application):
...
@pytest.mark.asyncio
async def test_update_weak_usage_accumulates_totals(application: Application):
...
@pytest.mark.asyncio
async def test_reset_usage_clears_all_counters(application: Application):
...
@pytest.mark.asyncio
async def test_reset_context_clears_context_only(application: Application):
...
@pytest.mark.asyncio
async def test_humanizer_formats_small_numbers(application: Application):
...
@pytest.mark.asyncio
async def test_humanizer_formats_thousands(application: Application):
...
@pytest.mark.asyncio
async def test_humanizer_formats_millions(application: Application):
...
@pytest.mark.asyncio
async def test_humanizer_formats_billions(application: Application):
...
@pytest.mark.asyncio
async def test_humanizer_formats_trillions(application: Application):
...
@pytest.mark.asyncio
async def test_humanizer_handles_floats(application: Application):
...
@pytest.mark.asyncio
async def test_usage_panel_hook_returns_payload(application: Application):
...
@pytest.mark.asyncio
async def test_usage_panel_hook_adds_panel_to_info_panel(application: Application):
...
@pytest.mark.asyncio
async def test_usage_panel_hook_preserves_existing_panels(application: Application):
...
@pytest.mark.asyncio
async def test_mixed_main_and_weak_usage(application: Application):
...
@pytest.mark.asyncio
async def test_last_message_tracks_most_recent_update(application: Application):
...
@pytest.mark.asyncio
async def test_zero_token_usage(application: Application):
...
@pytest.mark.asyncio
async def test_large_token_counts(application: Application):
