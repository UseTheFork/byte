...
"""
    test_file = await create_test_file(application, "greet.php", initial_content)
...
"""
    test_file = await create_test_file(application, "temp.php", test_content)
...
"""
    existing_file = await create_test_file(application, "calculator.php", existing_content)
...
"""
    delete_file = await create_test_file(application, "old_code.php", delete_content)
