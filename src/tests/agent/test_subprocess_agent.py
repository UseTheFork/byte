...
class TestSubprocessAgent(BaseTest):
    ...
    @pytest.mark.asyncio
    async def test_subprocess_agent_executes_command(self, application: Application, mocker):
    ...
    @pytest.mark.asyncio
    async def test_subprocess_agent_user_declines_adding_output(self, application: Application, mocker):
    ...
    @pytest.mark.asyncio
    async def test_subprocess_agent_command_with_stderr(self, application: Application, mocker):
    ...
    @pytest.mark.asyncio
    async def test_subprocess_agent_command_with_exit_code(self, application: Application, mocker):
    ...
    @pytest.mark.asyncio
    async def test_subprocess_agent_multiple_commands_in_sequence(self, application: Application, mocker):
    ...
    @pytest.mark.asyncio
    async def test_subprocess_agent_metadata_attributes_in_context(self, application: Application, mocker):
