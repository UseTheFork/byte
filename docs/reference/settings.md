...
| Field                   | Type                   | Default          | Description                                                                                                                                                            |
| ----------------------- | ---------------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `edit_format_type`      | `search_replace, diff` | `search_replace` | Type of edit format to use for code modifications. Options: 'search_replace' for SEARCH/REPLACE blocks, 'diff' for unified diff format, for complete file replacement. |
