...
class Command(ABC):
    ...
    def __init__(self, container=None):
        ...
        if container:
            self.boot()
            # Auto-boot all mixins that have boot methods
            self._boot_mixins()
    ...
    def boot(self) -> None:
        """Boot method called after command initialization.
        ...
        accessing other services. Called automatically after __init__.
        Usage: `def boot(self): self.event_dispatcher = self.container.make("event_dispatcher")`
        """
        pass
...
class CommandRegistry:
    ...
    def register_slash_command(self, command: Command):
        ...
        Usage: `registry.register_slash_command(AddFileCommand())`
        """
